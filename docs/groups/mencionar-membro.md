...
# <Icon name="AtSign" size="lg" /> Mencionar Membro

Mencione participantes em um grupo através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método é responsável por fazer a menção dos participantes em um grupo. Quando você menciona um participante, ele recebe uma notificação especial no WhatsApp.

**Funcionalidades**:
- Mencionar um ou vários membros do grupo
- Incluir o "@" na mensagem para destacar a menção
- Marcar todos os membros do grupo de uma vez
...
## <Icon name="Code" size="md" /> Exemplo de Código {#exemplos}
