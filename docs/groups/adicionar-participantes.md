...
Adicione novos membros a um grupo existente do WhatsApp através da API do Z-API. Você precisa ser administrador do grupo para adicionar participantes.
...
- Máximo de 256 participantes por grupo
- Apenas administradores podem adicionar participantes
- Números devem estar no formato internacional
- Verifique o array `failed` na resposta para identificar participantes que não foram adicionados
- Os participantes receberão uma notificação de que foram adicionados ao grupo
