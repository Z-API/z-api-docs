...
# <Icon name="Users" size="lg" /> Mencionar Grupo

Mencione grupos relacionados a uma comunidade através da API do Z-API.
...
**Requisitos**:
- O grupo onde a mensagem será enviada deve pertencer a uma comunidade
- Os grupos mencionados devem pertencer à mesma comunidade
- Você pode mencionar grupos e participantes na mesma mensagem
...
- [Mencionar Membro](/docs/groups/mencionar-membro) - Mencionar participantes em um grupo
- [Comunidades](/docs/communities/introducao) - Documentação sobre comunidades
