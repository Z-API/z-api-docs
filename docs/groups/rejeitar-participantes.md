...
# <Icon name="UserX" size="lg" /> Rejeitar Participantes

Rejeite a entrada de participantes no grupo através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método é responsável por rejeitar a entrada de participantes no grupo. Use este endpoint quando um grupo estiver configurado para requerer aprovação de administradores e você desejar rejeitar a solicitação de entrada de um ou mais participantes.
...
```csharp
var client = new RestClient("https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/reject-participant");
