...
# <Icon name="UserCheck" size="lg" /> Aprovar Participantes

Aceite a entrada de participantes no grupo através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método é responsável por aceitar a entrada de participantes no grupo. Use este endpoint quando um grupo estiver configurado para requerer aprovação de administradores e você desejar aprovar a solicitação de entrada de um ou mais participantes.
...
- [Rejeitar Participantes](/docs/groups/rejeitar-participantes) - Rejeitar entrada de participantes no grupo
- [Adicionar Participantes](/docs/groups/adicionar-participantes) - Adicionar participantes diretamente ao grupo
- [Configurações do Grupo](/docs/groups/configuracoes) - Configurar se o grupo requer aprovação
