...
# <Icon name="UserCog" size="lg" /> Promover Administrador

Promova um ou mais participantes de um grupo a administradores através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método permite promover participantes de um grupo a administradores. Administradores têm permissões especiais, como adicionar/remover participantes, alterar configurações do grupo e promover outros administradores.
...
|-------|------|-----------|
| `value` | boolean | `true` se a promoção foi bem-sucedida, `false` em caso de falha |
...
| `400` | Parâmetros inválidos | Verifique se o `groupId` e o array `phones` estão corretos |
...
- **Permissão**: Apenas administradores do grupo podem promover outros participantes
- **Múltiplos participantes**: Você pode promover vários participantes de uma vez enviando múltiplos números no array `phones`
- **Permissões de admin**: Administradores podem adicionar/remover participantes, alterar configurações e promover outros admins
