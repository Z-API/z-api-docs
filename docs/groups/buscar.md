...
Busque grupos do WhatsApp através da API do Z-API. Use este endpoint para encontrar grupos por nome ou outros critérios.
...
Exemplo da URL com os atributos:
...
|--------|-----------------------|----------------------------------------------------|
| 400 | Parâmetros inválidos | Verifique o `query` |
| 401 | Token inválido | Verifique o header `Client-Token` |
| 404 | Chat não encontrado | Verifique se o `query` está correto |
...
- Retorna apenas grupos dos quais você faz parte
- A busca é case-insensitive
- Grupos são retornados em ordem de relevância
