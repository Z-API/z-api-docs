...
# <Icon name="CheckCircle" size="lg" /> Aceitar Convite do Grupo

Aceite um convite para participar de um grupo através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método permite aceitar um convite para participar de um grupo. O link de convite pode ser obtido através de mensagens recebidas ou através do método [Obter Link de Convite](/docs/groups/obter-link).
...
## <Icon name="List" size="md" /> Atributos {#atributos}

### Obrigatórios

| Atributos | Tipo | Descrição |
|-----------|------|-----------|
| `url` | string | Url recebida de convite do grupo. Pode ser obtida [nesse webhook](/docs/webhooks/ao-receber#exemplo-de-retorno-de-texto) |
...
|-------|------|-----------|
| `success` | boolean | `true` se o convite foi aceito com sucesso, `false` em caso de falha |
...
| `400` | URL inválida | Verifique se a URL do convite está correta e válida |

---

## <Icon name="Webhook" size="md" /> Webhook Relacionado {#webhook}

O link de convite pode ser obtido através do webhook quando você recebe uma mensagem com um link de grupo. Veja mais detalhes em:

[Webhook ao receber mensagem - Exemplo de retorno de texto](/docs/webhooks/ao-receber#exemplo-de-retorno-de-texto)

---

## <Icon name="Info" size="md" /> Observações {#observacoes}

- **URL do convite**: A URL deve ser o link completo do WhatsApp (ex: `https://chat.whatsapp.com/...`)
- **Obter URL**: A URL pode ser obtida através de mensagens recebidas ou através do método [Obter Link de Convite](/docs/groups/obter-link)
- **Encoding**: Certifique-se de fazer encoding da URL ao enviar como parâmetro de query
