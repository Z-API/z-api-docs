...
Obtenha informações detalhadas sobre um grupo do WhatsApp através da API do Z-API. Use este endpoint para recuperar dados completos do grupo.
...
|-----------|--------|----------------------------------------------|
| groupId | string | ID do grupo (formato antigo: "551199999999-1623281429" ou formato novo: "120363019502650977-group") |
...
| isAdmin | boolean | Indica se o participante é administrador do grupo |
| isSuperAdmin | boolean | Indica se é o criador do grupo |
...
|--------|-----------------------|----------------------------------------------------|
| 400 | Parâmetros inválidos | Verifique o `groupId` |
| 401 | Token inválido | Verifique o header `Client-Token` |
| 404 | Chat não encontrado | Verifique se o `groupId` está correto |
...
- Você precisa fazer parte do grupo para obter sua metadata
- Retorna informações completas incluindo participantes e administradores
- O campo `owner` identifica o criador do grupo
- Use o `groupId` retornado em outras operações do grupo
- A metadata inclui nome, descrição, foto e lista de participantes
