...
|--------|-----------------------|----------------------------------------------------|
| 400 | Parâmetros inválidos | Verifique o `chatId` |
| 401 | Token inválido | Verifique o header `Client-Token` |
| 404 | Chat não encontrado | Verifique se o `chatId` está correto |
...
O `chatId` pode ter diferentes formatos dependendo do tipo de chat:
