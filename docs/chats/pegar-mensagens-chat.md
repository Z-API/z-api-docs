...
:::caution Atenção!
Este método não está disponivel na versão Multi Device, pois o Z-API não armazena as mensagens. A única maneira de obter as mensagens recebidas na versão Multi Device são via [Webhook de mensagens recebidas](../webhooks/ao-receber)
:::
