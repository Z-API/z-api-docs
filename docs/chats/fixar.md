...
Fixar ou desafixar um chat no topo da lista de conversas através da API do Z-API. Use este endpoint para manter chats importantes sempre visíveis.
...
- Chats fixados aparecem no topo da lista de conversas
- Você pode fixar múltiplos chats
- Use este endpoint para manter conversas importantes sempre acessíveis
