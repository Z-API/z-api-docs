...
# <Icon name="Image" size="lg" /> Imagem do Contato

Obtenha a URL atualizada da foto de perfil de um contato específico.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método retorna a URL atualizada da foto de perfil de um contato. Diferente do método [Metadata do Contato](/docs/contacts/metadata), que retorna um link que expira em 48 horas, este método sempre retorna um link atualizado.
...
**Use este método** quando precisar de um link atualizado da foto de perfil do contato.
:::
...
|-------|------|-----------|
| `link` | string | URL com a foto do contato atualizada |
...
| `404` | Contato não encontrado ou sem foto | Verifique se o número está correto e se o contato possui foto de perfil |

---

## <Icon name="Info" size="md" /> Observações {#observacoes}

- **Link atualizado**: Este método sempre retorna um link atualizado, diferente do `imgUrl` do metadata que expira em 48 horas
- **Sem foto**: Se o contato não tiver foto de perfil, a resposta pode ser vazia ou retornar erro 404
- **Armazenamento**: Se precisar armazenar a foto, faça o download da imagem usando a URL retornada, pois o link pode expirar
