...
`GET` https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/add-participant
...
| :-- | :-: | :-- |
| groupId | string | Telefone do destinatário no formato DDI DDD NUMERO Ex: 551199999999. **IMPORTANTE** Envie somente números, sem formatação ou máscara |
...
{ "groupId": "string", "phones": [ "5544999999999" ] }
