...
Obtenha a lista de contatos do WhatsApp da sua instância.
...
Inserir atributos de `page` e `pageSize`, é possível inserir na URL da requisição.

#### Obrigatórios

| Atributos | Tipo    | Descrição                                                                        |
| --------- | ------- | -------------------------------------------------------------------------------- |
| page      | integer | Utilizado para paginação você de informar aqui a página de chats que quer buscar |
...
- A lista pode conter muitos contatos; considere implementar paginação se necessário
- Contatos podem não ter nome se não estiverem salvos na sua agenda
