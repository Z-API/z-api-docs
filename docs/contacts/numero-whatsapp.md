---
id: numero-whatsapp
title: Verificar Número com WhatsApp
sidebar_position: 4
---
...
# <Icon name="CheckCircle" size="lg" /> Verificar Número com WhatsApp

Verifique se um número de telefone possui WhatsApp ativo.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método retorna se o número possui ou não WhatsApp ativo. É útil para validação de formulários e verificação de números antes de adicionar à sua base de contatos.

:::important Importante
Utilize essa API sempre que quiser verificar se um número possui WhatsApp, geralmente para **validação de formulários**.

**Não utilize** essa API caso queira fazer uma verificação antes de enviar uma mensagem, pois o Z-API já valida a existência do número a cada mensagem enviada. A utilização desse método para esse fim pode gerar problemas, visto que a verificação ficaria duplicada.

Z-API não foi desenvolvido para disseminação de spam para contatos que você não conhece. Utilize com sabedoria!
:::
...
| phone     | string  | Número formatado de acordo com a resposta do WhatsApp                                                                 |
...
| `400` | Número inválido | Verifique se o número está no formato correto (DDI DDD NÚMERO) |

---

## <Icon name="Info" size="md" /> Observações {#observacoes}

- **Uso recomendado**: Validação de formulários e verificação de números antes de adicionar à base
- **Não recomendado**: Verificar antes de enviar mensagens (o Z-API já faz isso automaticamente)
- **Resposta**: A resposta é um array com um objeto contendo o campo `exists`
- **Performance**: Para validar múltiplos números, use o método [Validar Números em Lote](/docs/contacts/validar-lote)
