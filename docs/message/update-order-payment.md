...
| orderStatus     | string | Status atual do pedido (pending, processing, shipped, completed, canceled) (retornado no **[webhook](../webhooks/on-message-received#exemplo-de-retorno-de-pedido)**) |
