...
title: Atualizar Nome de Perfil
sidebar_position: 5
---
...
# <Icon name="UserCircle" size="lg" /> Atualizar Nome de Perfil

Altere o nome de perfil exibido no WhatsApp através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método permite alterar o nome de perfil exibido no WhatsApp. O nome será atualizado para todos os contatos que visualizarem seu perfil.
...
```http
PUT https://api.z-api.io/instances/{instanceId}/token/{token}/profile-name
```
...
|----------|------|-----------|
| `value` | string | Nome do perfil que será exibido no WhatsApp |
...
- O nome do perfil será atualizado imediatamente após a requisição bem-sucedida
- O nome será visível para todos os contatos que visualizarem seu perfil
- Não há limite de caracteres, mas recomenda-se manter o nome conciso e profissional
