...
# <Icon name="PhoneOff" size="lg" /> Rejeitar Chamadas

Ative a rejeição automática de chamadas de voz recebidas pela sua instância. Quando ativada, todas as chamadas de voz serão rejeitadas automaticamente.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método permite configurar a rejeição automática de chamadas de voz. Quando ativado, todas as chamadas recebidas pelo número conectado à API serão rejeitadas automaticamente, sem necessidade de intervenção manual.
...
|----------|------|-----------|
| `value` | boolean | `true` para ativar rejeição automática, `false` para desativar |
...
Você também pode configurar a rejeição automática de chamadas através do painel administrativo:

![Configuração de rejeição de chamadas](/img/call-reject.jpeg)

---

## <Icon name="Info" size="md" /> Observações {#observacoes}

- A rejeição automática se aplica apenas a **chamadas de voz**
- Quando ativada, todas as chamadas recebidas serão rejeitadas automaticamente
