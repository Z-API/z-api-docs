...
Desconecte sua instância do WhatsApp de forma controlada. Use este endpoint quando precisar desconectar temporariamente ou antes de deletar uma instância.
...
| 409 | Instância já desconectada | A instância já está desconectada |
...
- Você precisar desconectar temporariamente a instância
- Você for deletar uma instância (desconecte antes de deletar)
- Você quiser forçar uma nova conexão (desconecte e depois reconecte)
- Você precisar pausar o envio de mensagens temporariamente

## Importante {#importante}

:::warning Atenção

Após desconectar, a instância não poderá enviar ou receber mensagens até ser reconectada. Você precisará ler o QR Code novamente para reconectar.

:::

## Notas {#notas}

- A desconexão é imediata e não pode ser revertida sem reconectar
- Após desconectar, você receberá um webhook de desconexão
- Mensagens pendentes na fila não serão enviadas após a desconexão
- Para reconectar, use o endpoint de QR Code e leia o código com o WhatsApp
- Desconectar é útil para manutenção ou quando você não precisa da instância ativa
