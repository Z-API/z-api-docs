...
# <Icon name="Image" size="lg" /> Atualizar Imagem de Perfil

Altere a imagem de perfil exibida no WhatsApp através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método permite alterar a imagem de perfil exibida no WhatsApp. A imagem deve ser fornecida através de uma URL pública acessível.
...
|----------|------|-----------|
| `value` | string | URL pública da imagem que será usada como foto de perfil |
...
| `400` | URL inválida ou imagem inacessível | Verifique se a URL da imagem é válida e acessível publicamente |

---

## <Icon name="Info" size="md" /> Observações {#observacoes}

- A imagem deve estar disponível através de uma **URL pública acessível**
- Formatos suportados: JPG, PNG, GIF
- Tamanho recomendado: 640x640 pixels
- A imagem será atualizada imediatamente após a requisição bem-sucedida
- A imagem será visível para todos os contatos que visualizarem seu perfil
