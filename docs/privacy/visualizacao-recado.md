...
# <Icon name="FileText" size="lg" /> Visualização do Recado

Configure quem pode ver o recado do seu perfil.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Através deste método, é possível configurar quem pode ver o recado do seu perfil. O recado é a mensagem de status que aparece no seu perfil do WhatsApp.

**Opções disponíveis**:
- **Todos** (`ALL`): Qualquer pessoa pode ver seu recado
- **Ninguém** (`NONE`): Ninguém pode ver seu recado
...
- **Blacklist independente**: A blacklist de recado é independente das outras configurações de privacidade
