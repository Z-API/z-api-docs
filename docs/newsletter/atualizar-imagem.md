...
Este método é responsável por alterar a imagem (foto de perfil) de um canal já existente.
...
| pictureUrl | string | URL pública da imagem ou string Base64 da imagem |
...
Se você tem dúvidas em como enviar uma imagem Base64, o funcionamento é similar ao envio de mensagens de imagem. Verifique a seção de envio de imagens para mais detalhes sobre o formato.
:::
...
| Atributos | Tipo | Descrição |
|-----------|------|-----------|
| value | boolean | true caso tenha dado certo, false em caso de falha |
