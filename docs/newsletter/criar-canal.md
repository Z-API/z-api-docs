...
Este método é responsável por criar um canal. Infelizmente não é possível criar o canal com imagem, mas você pode logo após a criação utilizar-se do método update-newsletter-picture que está nesta mesma seção.
