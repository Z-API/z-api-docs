...
Este método é responsável por aceitar o convite para se tornar administrador de uma newsletter. Este convite é uma mensagem que você pode tanto enviar quanto receber através do webhook de mensagem recebida.
