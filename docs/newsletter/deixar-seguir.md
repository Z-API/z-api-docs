...
Este método é responsável por fazer a instância deixar de seguir uma newsletter.
...
:::warning
O ID da newsletter deve sempre incluir o sufixo "@newsletter", pois este é o padrão utilizado pelo próprio WhatsApp.
:::
...
| Atributos | Tipo | Descrição |
|-----------|------|-----------|
| value | boolean | true se com sucesso, false em caso de falha |
