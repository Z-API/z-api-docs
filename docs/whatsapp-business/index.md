...
sidebar_position: 0
description: Gerencie produtos, catálogos, etiquetas e perfil comercial para otimizar suas operações no WhatsApp Business.
---
...
Use funcionalidades específicas do WhatsApp Business através da API do Z-API. Gerencie produtos, catálogos, etiquetas e anotações para otimizar suas operações comerciais.

</div>

---

## <Icon name="ShoppingCart" size="md" /> Produtos e Catálogo
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Criar Produto</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Editar Produto</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Pegar Produtos</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Pegar Produtos por Telefone</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Pegar Produto por ID</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Deletar Produto</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Configuração do Catálogo</h3>
  </div>
  <div className={styles.cardDescription}>
...
## <Icon name="Folders" size="md" /> Coleções
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Criar Coleção</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    <Icon name="List" size="md" className={styles.cardIcon} />
    <h3 className={styles.cardTitle}>Listar Coleções</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    <Icon name="Edit3" size="md" className={styles.cardIcon} />
    <h3 className={styles.cardTitle}>Editar Coleção</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    <Icon name="Trash2" size="md" className={styles.cardIcon} />
    <h3 className={styles.cardTitle}>Deletar Coleção</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Adicionar Produtos à Coleção</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Remover Produtos da Coleção</h3>
  </div>
  <div className={styles.cardDescription}>
...
## <Icon name="Tags" size="md" /> Etiquetas (Labels)
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    <Icon name="Search" size="md" className={styles.cardIcon} />
    <h3 className={styles.cardTitle}>Buscar Etiquetas</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Criar Etiqueta</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    <Icon name="Edit3" size="md" className={styles.cardIcon} />
    <h3 className={styles.cardTitle}>Editar Etiqueta</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    <Icon name="Trash2" size="md" className={styles.cardIcon} />
    <h3 className={styles.cardTitle}>Deletar Etiqueta</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Atribuir Etiquetas</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    <Icon name="XSquare" size="md" className={styles.cardIcon} />
    <h3 className={styles.cardTitle}>Remover Etiquetas</h3>
  </div>
  <div className={styles.cardDescription}>
...
## <Icon name="Briefcase" size="md" /> Perfil Comercial
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Alterar Descrição da Empresa</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Alterar Endereço da Empresa</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Alterar Email da Empresa</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Alterar Websites da Empresa</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Alterar Horário de Funcionamento</h3>
  </div>
  <div className={styles.cardDescription}>
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Atribuir Categorias</h3>
  </div>
  <div className={styles.cardDescription}>
...
## <Icon name="StickyNote" size="md" /> Anotações
...
<div className={styles.card}>
  <div className={styles.cardHeader}>
    ...
    <h3 className={styles.cardTitle}>Atribuir Anotações</h3>
  </div>
  <div className={styles.cardDescription}>
...
:::warning Conta Business Necessária

Todas as funcionalidades desta seção requerem uma conta WhatsApp Business verificada. Certifique-se de ter sua conta configurada antes de usar estas APIs!
