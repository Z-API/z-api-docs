...
# <Icon name="Settings" size="lg" /> Configuração do Catálogo

Configure as opções do seu catálogo do WhatsApp Business através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método permite editar as configurações do seu catálogo, incluindo a habilitação ou desabilitação do carrinho de compras.
...
|----------|------|-----------|
| `cartEnabled` | boolean | `true` para ativar o carrinho de compras, `false` para desativar |
...
|-------|------|-----------|
| `success` | boolean | `true` se a configuração foi atualizada com sucesso, `false` em caso de falha |
...
| `400` | Parâmetros inválidos | Verifique se o `cartEnabled` está correto (deve ser boolean) |

---

## <Icon name="Info" size="md" /> Observações {#observacoes}

- **Carrinho de compras**: Quando `cartEnabled` é `true`, os clientes podem adicionar múltiplos produtos ao carrinho antes de finalizar a compra
- **WhatsApp Business**: Este método requer uma conta WhatsApp Business configurada
- **Catálogo**: Certifique-se de ter produtos cadastrados no catálogo antes de ativar o carrinho
