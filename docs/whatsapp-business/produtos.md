...
Gerencie produtos do seu catálogo WhatsApp Business através da API do Z-API. Use este endpoint para criar, editar e listar produtos.
...
|--------|-----------------------|----------------------------------------------------|
| 400 | Parâmetros inválidos | Verifique os campos obrigatórios (name, price, currency) |
...
- Use este endpoint para criar, editar e listar produtos do catálogo WhatsApp Business
- Campos obrigatórios: `name`, `price`, `currency`
- Campos opcionais: `description`, `images`, `category`
- O preço deve ser um número positivo
- A moeda deve seguir o padrão ISO (ex: BRL, USD, EUR)
- As imagens devem ser URLs válidas e acessíveis
