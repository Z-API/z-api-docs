...
# <Icon name="FolderPlus" size="lg" /> Criar Coleção

Crie uma coleção de produtos no seu catálogo do WhatsApp Business através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método permite criar uma coleção de produtos no seu catálogo. Coleções são grupos de produtos organizados por categoria, tipo ou qualquer critério que você definir.
...
| `productIds` | array | Array com os IDs dos produtos que farão parte da coleção. Ex: `["121212121212", "232323232323"]` |
...
|-------|------|-----------|
| `collectionId` | string | ID da coleção criada |
...
| `400` | Parâmetros inválidos | Verifique se o `name` e `productIds` estão corretos |
| `404` | Produtos não encontrados | Certifique-se de que os IDs dos produtos existem no catálogo |

---

## <Icon name="Info" size="md" /> Observações {#observacoes}

- **Produtos existentes**: Os IDs dos produtos devem existir no catálogo antes de criar a coleção
- **Múltiplos produtos**: Você pode adicionar quantos produtos quiser na coleção
- **WhatsApp Business**: Este método requer uma conta WhatsApp Business configurada
- **Gerenciar coleção**: Após criar, você pode [editar](/docs/whatsapp-business/editar-colecao), [listar](/docs/whatsapp-business/listar-colecoes) ou [deletar](/docs/whatsapp-business/deletar-colecao) a coleção
