...
# <Icon name="Search" size="lg" /> Buscar Etiquetas

Busque todas as etiquetas cadastradas na sua conta WhatsApp Business através da API do Z-API.

---

## <Icon name="Info" size="md" /> Conceituação {#conceituacao}

Este método retorna todas as etiquetas (tags) cadastradas na sua conta WhatsApp Business. Etiquetas são usadas para organizar e categorizar conversas.
...
| `color` | number | Identificador da cor da etiqueta (0-5) |
...
:::tip Dica
Para obter a lista completa de cores disponíveis e seus valores hexadecimais, consulte [Cores de Etiquetas](/docs/whatsapp-business/cores-etiquetas).
:::
...
| `400` | Multi-Devices não habilitado | Certifique-se de que a instância está conectada à versão Multi-Devices |
...
- **Etiquetas**: As etiquetas são usadas para organizar conversas e facilitar a busca
- **Cores**: Cada etiqueta pode ter uma cor associada para melhor visualização
- **Gerenciar etiquetas**: Você pode [criar](/docs/whatsapp-business/criar-etiqueta), [editar](/docs/whatsapp-business/editar-etiqueta) ou [deletar](/docs/whatsapp-business/deletar-etiqueta) etiquetas
- **Atribuir etiquetas**: Use [Atribuir Etiquetas](/docs/whatsapp-business/atribuir-etiquetas) para associar etiquetas a conversas
