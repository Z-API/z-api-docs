...
1. **Faça o Login na Z-API**: Acesse o painel de controle da Z-API com suas credenciais de administrador.
...
![Tela de Configuração de Restrição de IP](https://developer.z-api.io/assets/images/ip-block-e0d5f2cc124f2010619c765472855357.jpeg)
