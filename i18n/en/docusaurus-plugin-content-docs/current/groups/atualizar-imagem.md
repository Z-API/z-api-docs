...
# <Icon name="Image" size="lg" /> Update Group Image

Change the profile image of an existing group through the Z-API.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method allows changing the profile image of an existing group. The image can be provided via a public URL or Base64.
...
Make sure to use the correct format of __PROTECTED_1c5aa05e-7dbc-4723-b232-e9398ac58b91__ based on the group's creation date.
:::

:::tip Send Base64 Image
If you have questions about sending a Base64 image, access the topic [Send Image](/docs/messages/imagem), where you will find everything needed about sending in this format.
:::
...
| `groupPhoto` | string | Public URL or Base64 image to be used as group photo |
...
| `400` | Invalid parameters or image | Check if the `groupId` is correct and if the URL/imagem Base64 is valid |

---

## <Icon name="Info" size="md" /> Notes {#observacoes}

- **Permission**: Only group administrators can change the image
- **Supported formats**: Public URL or Base64
- **Image formats**: JPG, PNG, GIF are supported
- **Recommended size**: 640x640 pixels
- **Group ID format**: Use the old format for groups created before November 4, 2021, or the new format for groups created after this date
- **Base64**: To send in Base64, consult the documentation of [Send Image](/docs/messages/imagem)