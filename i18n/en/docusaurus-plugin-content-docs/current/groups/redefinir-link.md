...
# <Icon name="RefreshCw" size="lg" /> Redefine Invitation Link

Redefines the invitation link of a group by generating a new link through the Z-API.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method allows you to reinitialize the invitation link of a group by generating a new one. The old link stops working and a new one is created.
...
|-------|------|------------|
| `invitationLink` | string | New group invitation link |
...
- **Old link**: The old link stops working after the redefinition
- **New link**: A new link is generated and returned in the response
...
- **Usage**: Use this method when you need to invalidate an old link and generate a new one