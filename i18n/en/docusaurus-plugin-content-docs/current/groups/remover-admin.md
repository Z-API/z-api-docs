...
Remove one or more administrators from a WhatsApp group through the Z-API.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method allows removing administrators from a group. After removal, participants lose their admin permissions and become regular members.
...
| `phones` | array string | Array with the numbers of administrators to be removed. Ex: `["5544999999999", "5544888888888"]` |
...
|-------|------|------------|
| `value` | boolean | `true` if removal was successful, `false` in case of failure |
...
| `403` | No permission | Only admins can remove other admins |

---

## <Icon name="Info" size="md" /> Notes {#observacoes}

- **Permission**: Only group admins can remove other admins
- **Multiple admins**: You can remove multiple admins at once by sending multiple numbers in the `phones` array
- **Effect**: After removal, participants lose their admin permissions
