...
id: metadata-convite
sidebar_position: 13
title: Metadata of Group by Invitation
---
...
# <Icon name="Info" size="lg" /> Metadata of Group by Invitation

Get detailed information about a group through the invitation link without needing to be in the group.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method returns the complete metadata of a group through the invitation link, including information about the group, participants, administrators, and other public information. You do not need to be in the group to get this information.
...
The `phone` returned in the response will follow the corresponding format to the group creation date.
:::
...
| `owner` | string | Number of the group creator |
...
| `participants` | array string | with data of the participants |
...
| `isAdmin` | string | Indicates if the participant is an administrator of the group |
| `isSuperAdmin` | string | Indicates if it's the creator of the group |
| `subjectTime` | timestamp | Date of creation of the group |
| `subjectOwner` | string | Number of the group creator |
...
In this case, make sure you are sending the correct specification of the method, that is, check if you sent POST or GET as specified at the beginning of this topic.
