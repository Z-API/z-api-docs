...
# <Icon name="Link" size="lg" /> Get Invitation Link

Obtain the invitation link of a group through the Z-API.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method allows obtaining the invitation link of a group. The link can be shared to allow others to join the group.
...
Make sure to use the correct format of `groupId` based on the creation date of the group.
:::
...
|-------|------|------------|
| `phone` | string | Group ID |
| `invitationLink` | string | Group invitation link |
...
- **Invitation link**: The returned link can be shared to allow others to join the group
...
- **Reset invitation link**: If you need to generate a new link, use the [Reset Invitation Link](/docs/groups/redefinir-link) method