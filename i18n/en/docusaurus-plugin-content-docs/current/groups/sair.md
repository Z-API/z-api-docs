...
# <Icon name="LogOut" size="lg" /> Leave Group

Leave a WhatsApp group through the Z-API.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method allows you to leave a group that you are part of. After leaving, you will no longer receive messages from the group and will not appear in the list of participants.
...
|-------|------|------------|
| `value` | boolean | `true` if the leave was successful, `false` in case of failure |
...
| `400` | Group not found | Check if the `groupId` is correct |

---

## <Icon name="Info" size="md" /> Notes {#observacoes}

- **Group ID Format**: Use the old format (`"5511999999999-1623281429"`) for groups created before November 4, 2021, or the new format (`"120363019502650977-group"`) for groups created after that date
- **Effect**: After leaving, you will no longer receive messages from the group
- **Irreversible**: You will need to be added back to the group to participate again