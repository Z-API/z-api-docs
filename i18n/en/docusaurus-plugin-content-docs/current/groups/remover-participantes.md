...
# <Icon name="UserMinus" size="lg" /> Remove Participants

Remove one or more participants from a WhatsApp group through the Z-API.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method allows removing participants from a group. Only group administrators can remove participants.
...
| `phones` | array string | Array with the number(s) of participant(s) to be removed |
...
### Example 1: New Format (Recommended) {#exemplo-formato-novo}
...
|-------|------|------------|
| `value` | boolean | `true` if the removal was successful, `false` in case of failure |
...
- **Permission**: Only group administrators can remove participants
- **Multiple participants**: You can remove multiple participants at once by sending multiple numbers in the `phones` array
...
- **Number format**: Send numbers in the DDI DDD NUMBER format without formatting or mask