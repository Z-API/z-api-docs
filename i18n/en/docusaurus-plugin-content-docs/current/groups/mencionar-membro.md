...
# <Icon name="AtSign" size="lg" /> Mention Member

Mention participants in a group through the Z-API.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method is responsible for mentioning participants in a group. When you mention a participant, they receive a special notification on WhatsApp.

**Features**:
- Mention one or multiple group members
- Include the "@" in the message to highlight the mention
...
This method allows you to mention multiple members of a group on WhatsApp without the need to explicitly include the "@" before the numbers. This is useful for tagging multiple members at once.
...
## <Icon name="Code" size="md" /> Example of Code {#examples}
