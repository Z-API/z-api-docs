...
Check the message queue of your instance through the Z-API API. Use this endpoint to list pending messages for processing.
...
|-----------|--------|-------------|----------------------------------------------|
| page | number | No | Page number of results |
| pageSize | number | No | Number of items per page |
| count | boolean | No | When present, returns only the item count |
...
| :--- | :--- | :--- |
| messages | array | Array with the queue messages |

#### Message Objects

| Attributes | Type | Description |
| :--- | :--- | :--- |
| _id | string | ID of the message in Z-API |
| DelayMessage | string | Time in seconds between sending messages |
| Message | string | Text of the Message |
| IsTrial | boolean | Indicates if the instance is using trial |
| InstanceId | string | ID of the instance |
| Phone | string | Recipient number |
| ZaapId | string | ID of the message in Z-API |
| DelayTyping | string | Duration of the chat "typing..." indicator |
| MessageId | string | ID of the message |
| Created | timestamp | Message date |
...
- Use pagination parameters to navigate through large volumes
- The `count` parameter returns only the total count
- Messages are ordered by processing order