...
Remove all messages from a queue instance through the Z-API API. Use this endpoint to completely empty the message queue.
...
|------|-----------------------|----------------------------------------------------|
| 400 | Invalid parameters | Check the `instanceId` |
...
- ⚠️ **WARNING**: This action is permanent and removes ALL messages from the queue
