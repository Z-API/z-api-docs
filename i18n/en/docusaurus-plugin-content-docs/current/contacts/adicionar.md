...
# <Icon name="UserPlus" size="lg" /> Add Contact

Add a new contact to your WhatsApp list through the Z-API. The contact will be saved in your WhatsApp address book.

:::danger Attention

This method will only work for accounts that have received the necessary update from WhatsApp. Make sure your WhatsApp account has received the update before using this feature.

Additionally, **it is required to allow WhatsApp to add contacts directly on your phone**. To do this, go to the privacy settings of your app and adjust the permissions so that WhatsApp can access and modify your contacts.

:::

<details>
  <summary>View examples of the update</summary>

  ![Example 1](https://developer.z-api.io/assets/images/add-contacts1-9717e55a45d140e7c6d40dd5616bbb37.jpeg)
  ![Example 2](https://developer.z-api.io/assets/images/add-contacts2-14688bc811cf124325921a696679167d.jpeg)
...
|--------|-------|----------|
| Client-Token | `[SEU_TOKEN]` | Yes |

### Request Body

The request body should be an array of objects, where each object represents a contact to be added.
...
|----------|------|----------|-------------|
| firstName | string | Yes | Name of the contact to be added in your address book |
| phone | string | Yes | Phone number of the contact to be added in your address book |
| lastName | string | No | Last name of the contact to be added in your address book |
...
| Code | Reason | Tip |
|------|--------|-----|
| 405 | Method Not Allowed | Check if you sent the POST correctly as specified at the beginning of this topic. |
| 415 | Unsupported Media Type | Make sure to add in the request headers "Content-Type" as "application/json". |
...
- **Number format**: Must be in international format (no spaces, hyphens or special characters)
- **Name**: Maximum of 100 characters
- **Duplicate contacts**: It is not possible to add the same number twice

## Notes

- The contact will be saved in your WhatsApp address book
- After adding, you can see the name of the contact in conversations
- Use international format for the number (ex.: `5511999999999`)
- The contact needs to be on WhatsApp to be added successfully