...
Get the list of chats (conversations) from your WhatsApp instance. Use this endpoint to list all conversations or filter by specific criteria.
...
| :--------- | :------ | :------------------------------------------------------------------------------------ |
| page       | integer | Used for pagination, you must inform here the chat page you want to search           |
...
- The list may contain many chats; consider implementing pagination if needed
- Use query parameters to filter results and reduce response size
- Group chats have `isGroup: true`
- Archived chats do not appear in the main WhatsApp list