...
# <Icon name="Smartphone" size="lg" /> Device Data

Obtain detailed information about the device (cell phone) connected to your instance.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method returns complete information about the device connected to the instance, including profile data, session information, and device settings.
...
|-------|------|-------------|
| `phone` | string | Instance phone number |
| `imgUrl` | string | Profile image URL |
| `about` | string | Description/status of profile |
| `name` | string | Profile name |
| `device` | object | Device information |
| `device.sessionName` | string | Session name (usually "Z-API") |
| `device.device_model` | string | Device model (usually "Z-API") |
| `originalDevice` | string | Original device (`"iphone"`, `"smbi"`, `"android"`, `"smba"`) |
| `sessionId` | number | Session ID |
| `isBusiness` | boolean | Indicates if it is a WhatsApp Business account |
...
- This endpoint returns real-time information about the connected device
- The field `originalDevice` indicates the type of original device used to connect
- The field `isBusiness` indicates if it is a WhatsApp Business account or not
- The `sessionId` is a unique identifier for the current session