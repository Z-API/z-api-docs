...
# <Icon name="CheckCircle" size="lg" /> Automatic Message Reading

Enable automatic reading of all messages received by your instance. When activated, the messages will be marked as read automatically.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method allows configuring automatic message reading. When activated, all messages received by the API will be marked as read automatically, without requiring manual intervention.
...
|----------|------|------------|
| `value` | boolean | `true` to activate automatic reading, `false` to deactivate |
...
You can also configure automatic reading through the admin panel:

![Automatic Reading Configuration](/img/auto-read.jpeg)

---

## <Icon name="Info" size="md" /> Notes {#observacoes}

- Automatic reading applies to **all received messages**
- When activated, the messages will be marked as read automatically
