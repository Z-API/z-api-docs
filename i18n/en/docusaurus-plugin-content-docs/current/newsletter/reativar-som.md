...
This method is responsible for reactivating the sound of a newsletter.
...
curl_easy_setopt(hnd, CURLOPT_URL, "https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter");
...
(client/put "https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter" {:headers {:client-token "{{security-token}}"}
                                                                                              :content-type :json
...
```csharp
var client = new RestClient("https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter");
...
```http
PUT /instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter HTTP/1.1
...
```java
HttpResponse<String> response = Unirest.put("https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter")
...
```js
fetch("https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter", {
  "method": "PUT",
  "headers": {
    "client-token": "{{security-token}}"
  },
...
xhr.open("PUT", "https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter");
...
var options = {
  ...
  "port": null,
  "path": "/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter",
  "headers": {
    "client-token": "{{security-token}}"
  }
};
...
var req = unirest("PUT", "https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter");
...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter"]
...
let uri = Uri.of_string "https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter" in
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter",
...
$request->setUrl('https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter');
...
$request->setRequestUrl('https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter');
...
$response = Invoke-WebRequest -Uri 'https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter' -Method PUT -Headers $headers -ContentType 'undefined' -Body '{"id": "ID do Canal"}'
```
...
$headers.Add("content-type", "application/json")
$headers.Add("client-token", "{{security-token}}")
$response = Invoke-RestMethod -Uri 'https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter' -Method PUT -Headers $headers -ContentType 'undefined' -Body '{"id": "ID do Canal"}'
```
...
conn.request("PUT", "/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter", payload, headers)
...
url = URI("https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter")
...
```bash
echo '{"id": "ID do Canal"}' |  \
  http PUT https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter \
  client-token:'{{security-token}}'
```
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.z-api.io/instances/SUA_INSTANCIA/token/SEU_TOKEN/unmute-newsletter")! as URL,
