...
This method is responsible for permanently deleting a channel.

:::danger
When deleting a channel, all content and followers will be lost permanently.
:::
...
Make sure you are sending the correct method specification, that is, check if you sent POST, DELETE or GET as specified at the beginning of this topic.
...
Link for the webhook response newsletter:
