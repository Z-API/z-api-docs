...
sidebar_position: 19
title: Transfer ownership of the channel
---
...
This method transfers the ownership (Ownership) of the channel to another administrator.
...
|-----------|------|-------------|
| newsletterId | string | ID of the channel (path parameter) |
| phone | string | Phone number of the new owner (must be an admin) |

### Optional

| Attributes | Type | Description |
|-----------|------|-------------|
| quitAdmin | boolean | If `true`, you will no longer be an admin after the transfer. Default: `false`. |
