...
# <Icon name="StickyNote" size="lg" /> Assign Notes to a Chat

Add custom notes to conversations in WhatsApp Business. Ideal for keeping important information about customers and conversations.
...
- **Customer Information**: Note preferences, purchase history or important details
- **Conversation Context**: Keep notes on the context of the conversation
- **Reminders**: Note reminders and tasks related to the chat
- **CRM Integration**: Synchronize information with CRM systems

---

## For No-Code Users

If you are using an automation platform like n8n or Make, use this endpoint to add notes to conversations based on specific events or conditions.
...
|----------|------|-----------|
| `phone` | string | Chat phone number in DDI DDD NUMBER format (ex: `5511999999999`). **IMPORTANT**: Send only numbers, without formatting or mask |
| `notes` | string | Text of the note to be added to the chat |
...
Through this method, you can assign notes to a chat in WhatsApp Business. Notes are visible only to you and your team, allowing you to maintain contextual information about conversations and customers.

**Features**:
- Notes are private and visible only to your account
...
- **Multi-Devices required**: This feature only works with Multi-Devices enabled
- **Contextual information**: Use notes to maintain context about customers and conversations
- **CRM integration**: Synchronize notes with CRM systems for better management
- **Privacy**: Notes are private and visible only to your account

---

## Next Steps

- [Tags](/docs/whatsapp-business/buscar-etiquetas) - Organize conversations with tags
