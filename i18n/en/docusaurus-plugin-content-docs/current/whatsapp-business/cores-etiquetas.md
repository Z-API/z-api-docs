...
# <Icon name="Palette" size="lg" /> Colors of Labels

List the available colors for labels in WhatsApp Business.

---

:::important Important

This method is available **only for Business accounts** on WhatsApp.
...
- **Visual Customization**: Choose colors to visually organize your labels
- **Categorization**: Use different colors for different categories of contacts
- **Quick Identification**: Identify types of contacts quickly by color

---

## For Non-Code Users

If you are using an automation platform like n8n or Make, use this endpoint to get the available colors before creating or editing labels.
...
Through this method, you can list the available label colors in WhatsApp Business. The colors are returned as hexadecimal values indexed numerically.

**Important**: Colors may vary between different platforms (Android / iPhone).
...
The response is an object where each key is a numerical index and the value is the corresponding hexadecimal color.

| Attribute | Type | Description |
|----------|------|-----------|
| `{INDICE_DA_COR}` | string | Hexadecimal of the color (ex: `"#FF9485"`) |
...
| Code | Description |
|--------|-----------|
| `405` | Incorrect HTTP method. Check if you are using `GET` |
...
Colors may vary between different platforms (Android / iPhone). Always visually test before using in production.

:::

- **Label Usage**: Use the returned indices to create or edit labels
- **Compatibility**: Verify that colors work well on different devices
- **Accessibility**: Consider contrast and readability when choosing colors

---

## Next Steps

- [Create Label](/docs/whatsapp-business/criar-etiqueta) - Create labels with colors
- [Edit Label](/docs/whatsapp-business/editar-etiqueta) - Edit existing label colors
- [Labels](/docs/whatsapp-business/buscar-etiquetas) - Manage your labels