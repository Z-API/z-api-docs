...
# <Icon name="Building" size="lg" /> Business Account Data

Get complete information about a WhatsApp Business account through the Z-API.

---

## <Icon name="Info" size="md" /> Conceptualization {#conceituacao}

This method returns all public information of a WhatsApp Business account, including description, address, email, websites, categories and operating hours.
...
|-----------|------|------------|
| `phone` | string | Business account phone number in DDI DDD NUMBER format (ex: `5511999999999`). **IMPORTANT**: Send only numbers, without formatting or mask |
...
| `415` | Missing Content-Type | This method does not require Content-Type, but if you send it, use `application/json` |
| `401` | Invalid token | Check the header `Client-Token` |
| `400` | Invalid parameters | Check if the `phone` is in the correct format (only numbers) |
| `404` | Account not found | Check if the number provided is a valid WhatsApp Business account |
...
- **Public information**: This method returns only public information of the business account
- **Operating hours**: The field `mode` can be `specificHours` (specific hours) or `alwaysOpen` (always open)
- **Categories**: Categories are defined by WhatsApp Business and cannot be changed directly
- **Update data**: To update account information, use the specific methods:
 - [Change Description](/docs/whatsapp-business/alterar-descricao-empresa)
 - [Change Address](/docs/whatsapp-business/alterar-endereco-empresa)
 - [Change Email](/docs/whatsapp-business/alterar-email-empresa)
 - [Change Websites](/docs/whatsapp-business/alterar-websites-empresa)
 - [Change Operating Hours](/docs/whatsapp-business/alterar-horario-funcionamento)