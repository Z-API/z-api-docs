...
Create a new WhatsApp community through the Z-API API. You will be automatically added as an administrator of the community.
...
| ---- | -------------------- | ------------------------------------------- |
| 400  | Invalid parameters   | Check the `name`                         |
| 401  | Invalid token        | Check the header `Client-Token`          |
| 404  | Chat not found       | Check if the `name` is correct         |
...
- You are automatically added as the administrator of the created community
- Max name length: 24 characters
- Max description length: 512 characters
- Use the `id` returned for other operations
- After creating, you can link existing groups to the community