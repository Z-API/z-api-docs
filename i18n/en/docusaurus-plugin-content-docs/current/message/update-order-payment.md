...
| orderStatus     | string | Current order status (pending, processing, shipped, completed, canceled) (returned in the **[webhook](../webhooks/on-message-received#send-order-return-example)**) |
